...
export default function OrderDetailsModal({ order, onClose, onUpdateStatus, onUpdateOrder, onEditOrder, onDeleteOrder, readOnly = false }: OrderDetailsModalProps) {
    ...
    // Checklists State
    const [checklistPhotolith, setChecklistPhotolith] = useState(order.checklist_photolith?.items || {
